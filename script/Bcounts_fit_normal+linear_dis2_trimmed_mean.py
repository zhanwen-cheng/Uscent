...
df_new['ori_Bcounts']=df_new.Bcounts
df_new['Bcounts'] = df_new.Bcounts*gc_table.gc
df_new.Bcounts=df_new.Bcounts/(stats.trim_mean(df_new.ori_Bcounts,0.05))
...
plt.scatter(df_new.ori_lable,df_new.ori_Bcounts,s=2)
plt.savefig('./Bcounts.jpg')
pdf.image('./Bcounts.jpg',w=5, h=2)
pdf.ln(0.2)
...
popthunt_left, pcovhunt_left = curve_fit(func1, df_new_left.new_lable, df_new_left.Bcounts,maxfev=50000)
popthunt_right, pcovhunt_right = curve_fit(func1, df_new_right.new_lable, df_new_right.Bcounts,maxfev=50000)
...
plt.savefig('./Bcounts_linear_fit_pic.jpg')
pdf.image('./Bcounts_linear_fit_pic.jpg',w=6, h=4)
pdf.ln(0.2)
...
popthunt2, pcovhunt2 = curve_fit(func2, df_new.new_lable, df_new.Bcounts,bounds=param_bounds,maxfev=50000) 
...
plt.savefig('./Bcounts_normal_fit_pic.jpg')
pdf.image('./Bcounts_normal_fit_pic.jpg',w=6, h=4)
pdf.ln(0.2)
