...
#popthunt1, pcovhunt1 = curve_fit(func1, df_new.new_lable, df_new.Ucounts,maxfev=50000) 
popthunt2, pcovhunt2 = curve_fit(func2, df_new.new_lable, df_new.Ucounts,maxfev=50000) 
...
plt.savefig('./Ucounts_fit_pic.jpg')
pdf.image('./Ucounts_fit_pic.jpg',w=6, h=4)
pdf.ln(0.2)
